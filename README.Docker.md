...
docker run -d \
  ...
  -e SUPABASE_BUCKET_NAME="wachat-media-bucket" \
...
# docker push your-registry/whatsapp-chat:latest

# Deploy to your container platform and configure environment variables
```
...
```bash
docker exec whatsapp-chat-app env | grep -E "SUPABASE"
```
