...
/**
 * POST handler for refreshing Supabase storage pre-signed URLs
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Determine which identifier was used as the storage owner when the media was stored
    const ownerIdForStorage = message.is_sent_by_me ? message.receiver_id : message.sender_id;
